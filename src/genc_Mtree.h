...
#define GENC_MTREE_NODE_FOREACH_BEGIN(self, child) \
GENC_MAP_FOREACH_BEGIN(GENC_MTREE_NODE_CHILDREN(self), child)

#define GENC_MTREE_NODE_FOREACH_END(self, child) \
GENC_MAP_FOREACH_END(self, child)
